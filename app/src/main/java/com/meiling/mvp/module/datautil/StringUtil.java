...
/**
 * TODO String handle work like: check empty , mobile phone number check, email address check and so on.
 *
...
public class StringUtil {
    ...
    private static Pattern patternW;//word
    private static Matcher matcherW;
    private static Pattern patternN;//number
    private static Matcher matcherN;
    private static Pattern patternC;// specific char
    private static Matcher matcherC;
    private static int typeNumberW = 0;//count word number
    private static int typeNumberN = 0;//count number number
    private static int typeNumberC = 0;//count specific char number
